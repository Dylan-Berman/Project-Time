...
const people = [
  {
    ...
    role: "CEO",
    image: "https://images.unsplash.com/photo-1543113415-ba3b69906499",
  },
  {
    name: "Johnny Cash",
    title: "Lead Analyst",
    department: "Optimization",
    email: "johnnyemail@example.com",
    role: "CFO",
                    ...
                    <td className="whitespace-nowrap py-5 pl-4 pr-3 text-sm sm:pl-0">
                      <div className="flex items-center">
                        <div className="h-11 w-11 flex-shrink-0">
                          <a href={person.image} target="_blank">
                            <img
                              className="h-11 w-11 rounded-full"
                              src={person.image + fitFaceQuery}
                              alt=""
                            />
                          </a>
                        </div>
